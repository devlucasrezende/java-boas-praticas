...
public class AdopetConsoleApplication {
    ...
    public static final String API_URL = "http://localhost:8080/abrigos/";
    ...
    private static void listarAbrigos() throws IOException, InterruptedException {
        ...
        HttpResponse<String> response = dispararRequisicao("", "GET", "", null);
    ...
    private static void cadastrarAbrigos() throws IOException, InterruptedException {
        ...
        HttpResponse<String> response = dispararRequisicao("", "POST", "", json);
    ...
    private static void listarPetsAbrigo() throws IOException, InterruptedException {
        ...
        HttpResponse<String> response = dispararRequisicao(idOuNome, "GET", "/pets", null);
        int statusCode = response.statusCode();
    ...
    private static void importarPetsAbrigo() throws IOException, InterruptedException {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            HttpResponse<String> response = dispararRequisicao(idOuNome, "POST", "/pets", json);
            int statusCode = response.statusCode();
            String responseBody = response.body();
            if (statusCode == 200) {
